...
jQuery(document).ready(function($)
{
  $('.royalSlider').css('display', 'block');
    ...
    $(".royalSlider").royalSlider({
        ...
        thumbs: {
        orientation: 'vertical', // Set the thumbnails to be vertical
        spacing: 4, // Adjust spacing between thumbnails
        arrows: true, // Show arrows for scrolling through thumbnails
        autoCenter: true,
        fitInViewport: true,
        touch: false,
        drag: false,
